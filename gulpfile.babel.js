// Generated on 2016-03-21 using generator-angular-fullstack 3.4.0
'use strict';
...
gulp.task('serve', cb => {
    runSequence(['clean:tmp', 'constant', 'tsd'],
        ['lint:scripts', 'inject', 'inject:tsconfig'],
        ['wiredep:client'],
...
gulp.task('constant', function() {
  ...
  return plugins.ngConstant({
    name: 'pocAngularfsApp.constants',
    deps: [],
    wrap: true,
    stream: true,
